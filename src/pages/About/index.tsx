...
export default function About() {
  useEffect(() => {
    document.title = "Entenda a Técnica Pomodoro - {APP_NAME} Pomodoro";
  }, []);

  return (
    <div className='genericHtml'>
      ...
      <h2>
        Mas no <strong>{APP_NAME} Pomodoro</strong> tem um diferencial 🚀
      </h2>
      ...
      <p>
        ...
        <Link href='/settings/'>página de configurações</Link> e ajustar os
      ...
      <p>
        ...
        <Link href='/history/'>histórico</Link>, com status de completas ou
        interrompidas. Assim, você consegue acompanhar sua evolução ao longo do
        tempo.
      </p>

      <h2>Por que usar o {APP_NAME} Pomodoro?</h2>
      <ul>
      ...
      <p>
        ...
        <Link href='/'>voltar para a página inicial</Link> e iniciar seus
        Pomodoros! 🍅🚀
      </p>
